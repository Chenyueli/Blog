...
1. 存储方式：cookie在浏览器和服务器间来回传递，sessionStorage 和localStorage不会自动把数据发给服务器，仅仅在**本地保存**。
...
<a href = "http://www.w3school.com.cn/html5/html_5_webstorage.asp" target ="_blank">HTML 5 Web存储</a>
...
## 七. HTML5 画布 canvas
canvas元素用于网页上绘制图形，强大之处在于可以直接在HTML上进行图形操作。canvas标签是图形容器，必须用脚本绘制图形。有一个基于JavaScript的绘图API。
...
优点：比gif等体积小，能够被大量压缩，无限放大，在retina屏中效果好，兼容ＩＥ８＋

<a href = "http://www.runoob.com/svg/svg-reference.html">SVG参考手册</a>
## 九. webworker、websoket实现多个页面间的通信
